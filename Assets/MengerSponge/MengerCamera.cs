...
[ExecuteInEditMode]
public class MengerCamera : SceneViewFilter
{
    ...
    [Range(0, 7)]
    public int _mengerIteratios;
    public float _mengerWidth;
    public Vector3 _mengerPos;
    public Color _mengerColor;
    ...
    void OnRenderImage(RenderTexture source, RenderTexture destination)
    {
        ...
        _raymarchMaterial.SetInt("_mengerIteratios", _mengerIteratios);
        _raymarchMaterial.SetFloat("_mengerWidth", _mengerWidth);
        _raymarchMaterial.SetVector("_mengerPos", _mengerPos);
        _raymarchMaterial.SetVector("_mengerColor", _mengerColor);

        _raymarchMaterial.SetInt("_showPlane", _planeInt);
